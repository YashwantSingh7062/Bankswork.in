   ...
   <div class="container pt-5 mt-5">
                ...
                <div class="wrapping">
                    <div class="col-md-12 col-lg-12 pad0l md-pad0">
                        <h1 class="font28 font18-xs marg0 font-weight700 text-blue"><i class="fa fa-lock" style="font-size:30px;"></i>
                            Privacy Policy
                        </h1>
                    </div>
                </div>
                ...
                <div class="wrapping pad30t">
                    <div class="col-md-12 col-lg-12 pad0">
                        ...
                        <p class="font15 font13-sm text-justfy">
                            This privacy policy (“<b>Policy</b>”) has been drafted in accordance with the Information Technology Act, 2000 and the Information Technology (Reasonable security practices and procedures and sensitive personal data or information) Rules, 2011.
                            <br>
                            <br>
                            GC Web Ventures Private Limited (hereinafter “<b>IndiaLends</b>” “<b>Us</b>”, “<b>Our</b>” “<b>We</b>”, which shall mean and include its affiliates, successors and assigns) owns and operates this website, whether accessible on <a href="https://indialends.com/" target="_blank" class="anchor-blue text-underline text-decoration-none">www.indialends.com</a> or such other URL as may be designated by IndiaLends, or through a mobile application, if available, (“<b>Website</b>”).                
                        </p>
                        ...
                        <p class="font15 font13-sm text-justfy">
                            ...
                            <br>
                            <br>
                            YOUR USE OF THE WEBSITE WILL BE GOVERNED BY THIS POLICY AS APPLICABLE TO THE WEBSITE TOGETHER WITH ALL POLICIES, NOTICES, GUIDELINES, DISCLAIMERS THAT ARE PUBLISHED AND SHARED WITH YOU FROM TIME TO TIME WHICH ARE INCORPORATED HEREIN BY WAY OF REFERENCE INCLUDING BUT NOT LIMITED TO OUR  <a href="https://indialends.com/terms-conditions" class="anchor-blue text-underline text-decoration-none" target="_blank">TERMS OF USE</a> AND SUCH OTHER TERMS AS MAY BE APPLICABLE TO YOU IN YOUR CAPACITY AS A USER OF THE WEBSITE. THIS POLICY SHALL BE ENFORCEABLE AGAINST YOU IN THE SAME MANNER AS ANY OTHER WRITTEN AGREEMENT.
                            <br>
                            <br>
                            THIS POLICY IS A PART OF THE WEBSITE TERMS AND CONDITIONS LOCATED <a href="https://indialends.com/terms-conditions" class="anchor-blue text-underline text-decoration-none" target="_blank">HERE</a> AND ALL CAPITALIZED TERMS UNDER THIS POLICY THAT HAVE NOT BEEN SPECIFICALLY DEFINED HEREIN SHALL HAVE THE MEANING AS ASCRIBED TO IT UNDER THE WEBSITE TERMS AND CONDITIONS.<br>
                            <br>
                        ...
                        <h2 class="font16 font15-sm font-weight700">A. IndiaLends Collection of Information
                        </h2>
                        ...
                        <ol class="font15 font13-sm text-justfy">
                            ...
                            <li>Details regarding Your employment, including, years of experience, details of income, name of the current employer, details of the office address, details regarding the years/months completed with the current employer;
                            </li>
                        ...
                        <h2 class="font16 font15-sm font-weight700">B. Use of Information 
                        </h2>
                        ...
                        <h2 class="font16 font15-sm font-weight700">C. Cookies
                        </h2>
                        ...
                        <p class="font15 font13-sm text-justfy">
                            If You require any information or clarification regarding the use of Your personal information or this Privacy Policy, You can contact us at <a href="mailto:support@indialends.com" class="anchor-blue text-underline text-decoration-none">support@indialends.com</a>.

                        </p>
                        <p class="font15 font13-sm text-justfy">If You have grievance with respect to use of Your personal information, please write to Us at <a href="mailto:grievanceofficer@indialends.com" class="anchor-blue text-underline text-decoration-none">grievanceofficer@indialends.com</a>. </p>
