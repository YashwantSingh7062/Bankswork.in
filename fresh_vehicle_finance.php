...
<body>
    ...
    <header id="header-car-loans">
      <div class="container text-center rellax" data-rellax-speed="-4">
              <h1 class="display-4">
                  Fresh Vehicle Finance starting at 10.75%
              </h1>
              <p>Apply for an online Vehicle Finance at low interest rates and get instant approval.</p>
      </div>   
    </header>
       ...
       <div class="card rellax mx-md-5" data-rellax-speed="2">
          <div class="card-header p-md-4">
             <div class="registration-step">1</div>
              <h1 class="display-4 text-center"><i class="fas fa-car" style="font-size:50px;"></i> Fresh Vehicle Finance Registration</h1>
          </div>
           <div class='card-body'>
